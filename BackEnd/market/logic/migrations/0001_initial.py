# Generated by Django 3.2.9 on 2021-11-13 23:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='Ссылка в браузере')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication_date', models.DateTimeField(default=datetime.datetime(2021, 11, 13, 23, 33, 46, 487809, tzinfo=utc), verbose_name='Дата публикации')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock_multipler', models.FloatField(default=0, verbose_name='Процент скидки по акции')),
                ('image', models.ImageField(blank=True, upload_to='products/sort/images/', verbose_name='Изображение сорта продукта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='logic.size', verbose_name='Размер')),
                ('sort', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='logic.sort', verbose_name='Сорт продукта')),
            ],
            options={
